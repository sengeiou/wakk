...
public class PowerConstants {
    ...
    public static final String CALL_PATH_SCHEDULE_STARTUP = "/power/startup/schedule";
    public static final String CALL_PATH_CANCEL_STARTUP = "/power/startup/schedule/cancel";

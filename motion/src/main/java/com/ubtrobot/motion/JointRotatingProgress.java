...
public class JointRotatingProgress {
    ...
    private JointRotatingProgress(String sessionId, int state) {
    ...
    public static class Builder {
        ...
        public JointRotatingProgress build() {
            return new JointRotatingProgress(sessionId, state);
        }
    }
}